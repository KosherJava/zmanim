...
public class ZmanimCalendar extends AstronomicalCalendar {
	...
	/**
	 * A type that returns a <em>shaah zmanis</em> ( {@link #getTemporalHour(Long, Long) temporal hour}) according to
	...
	/**
	 * A method that returns a <em>shaah zmanis</em> ( {@link #getTemporalHour(Long, Long) temporal hour}).
	 *
