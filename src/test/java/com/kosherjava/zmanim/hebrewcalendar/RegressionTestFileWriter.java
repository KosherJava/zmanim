...
//            cal.setIsMukafChoma();
        while (current.isBefore(end)) {
			...
			zmanim.add(new FullZmanim(zcal.getShaahZmanis19Point8Degrees(), zcal.getShaahZmanis18Degrees(),
					...
					zcal.getShaahZmanisAteretTorah(), zcal.getShaahZmanisAlos16Point1DegreesToTzaisGeonim3Point8Degrees(),
					zcal.getShaahZmanisAlos16Point1DegreesToTzaisGeonim3Point7Degrees(), zcal.getShaahZmanis96Minutes(),
					...
					zcal.getSofZmanShmaAlos16Point1DegreesToTzaisGeonim7Point083Degrees(),
					...
					zcal.getPlagAlos16Point1DegreesToTzaisGeonim7Point083Degrees(), zcal.getPlagAhavatShalom(),
