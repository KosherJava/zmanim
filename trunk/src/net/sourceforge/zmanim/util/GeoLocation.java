...
public class GeoLocation implements Cloneable {
	 ...
	 *            equator, a negative value should be used.
	 * @param longitude
	 ...
	 * @param minutes <a href="http://en.wikipedia.org/wiki/Minute_of_arc#Cartography">minutes of arc</a>
	 * @param seconds <a href="http://en.wikipedia.org/wiki/Minute_of_arc#Cartography">seconds of arc</a>
	 * @param direction
	 ...
	 * set in the {@link net.sourceforge.zmanim.AstronomicalCalendar}, it is
	 * critical that
	 * {@link net.sourceforge.zmanim.AstronomicalCalendar#getCalendar()}.{@link java.util.Calendar#setTimeZone(TimeZone) setTimeZone(TimeZone)}
	 ...
	 * ever {@link net.sourceforge.zmanim.AstronomicalCalendar#clone() cloned}.
	 * 
	 * @param timeZone
	 *            The timeZone to set.
	 */
	 ...
	 * {@link net.sourceforge.zmanim.AstronomicalCalendar#getSunTransit() noon}
	...
	public String toXML() {
		...
		sb.append("\t<LocationName>").append(getLocationName()).append(
				"</LocationName>\n");
		sb.append("\t<Latitude>").append(getLatitude()).append("&deg;").append(
				"</Latitude>\n");
		...
		sb.append("\t<TimezoneGMTOffset>").append(
				getTimeZone().getRawOffset() / HOUR_MILLIS).append(
				"</TimezoneGMTOffset>\n");
		sb.append("\t<TimezoneDSTOffset>").append(
				getTimeZone().getDSTSavings() / HOUR_MILLIS).append(
				"</TimezoneDSTOffset>\n");
		sb.append("</GeoLocation>");
		return sb.toString();
	}
	...
	/**
	 * An implementation of the {@link java.lang.Object#clone()} method that
	 * creates a <a
	 * href="http://en.wikipedia.org/wiki/Object_copy#Deep_copy">deep copy</a>
	 * of the object. <br/><b>Note:</b> If the {@link java.util.TimeZone} in
