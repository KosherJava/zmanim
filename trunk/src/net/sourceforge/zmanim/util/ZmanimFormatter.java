...
/**
 * A class used to format non {@link java.util.Date} times generated by the Zmanim package. For example the
 * {@link net.sourceforge.zmanim.AstronomicalCalendar#getTemporalHour()} returns the length of the hour in milliseconds.
 * This class can format this time.
 * 
